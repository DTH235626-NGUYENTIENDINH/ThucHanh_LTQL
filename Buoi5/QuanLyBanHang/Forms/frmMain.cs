...
namespace QuanLyBanHang.Forms
{
    public partial class frmMain : Form
    {
        ...
        frmNhanhVien nhanVien = null;
        frmHoaDon hoaDon = null;
        frmDangNhap dangNhap = null;
        frmThongKeSanPham danhSachSanPham = null;
        frmThongKeDoanhThu danhSachDoanhThu = null;
        ...
        {
            if (danhSachSanPham == null || danhSachSanPham.IsDisposed)
            {
                danhSachSanPham = new frmThongKeSanPham();
                danhSachSanPham.MdiParent = this;
                danhSachSanPham.Show();
            }
            else
                danhSachSanPham.Activate();
        }
        ...
        {
            if (danhSachDoanhThu == null || danhSachDoanhThu.IsDisposed)
            {
                danhSachDoanhThu = new frmThongKeDoanhThu();
                danhSachDoanhThu.MdiParent = this;
                danhSachDoanhThu.Show();
            }
            else
                danhSachDoanhThu.Activate();
        }
