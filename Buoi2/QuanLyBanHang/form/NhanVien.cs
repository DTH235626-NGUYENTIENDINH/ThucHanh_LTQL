...
namespace QuanLyBanHang.form
{
    public partial class NhanVien : Form
    {
        ...
        private void frmNhanVien_Load(object sender, EventArgs e)
        {
            ...
            List<QuanLyBanHang.Data.NhanVien> nv = new List<QuanLyBanHang.Data.NhanVien>(); 
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (xuLyThem)
                {
                    ...
                    {
                        QuanLyBanHang.Data.NhanVien nv = new QuanLyBanHang.Data.NhanVien();
                ...
                {
                    QuanLyBanHang.Data.NhanVien nv = context.NhanVien.Find(id);
                    if (nv != null)
                    {
                        nv.HoVaTen = txtHoVaTen.Text;
                        nv.DienThoai = txtDienThoai.Text;
